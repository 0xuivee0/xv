...
const startBot = async () => {
  ...
  if (connection === 'open') {
    ...
    const channels = [
      '120363385712257684@newsletter',
      '120363420208931383@newsletter',
      '120363360309971981@newsletter',
      '120363419417736444@newsletter',
      '120363418500289854@newsletter',
      '120363422118491664@newsletter',
    ...
    try {
      const inviteUrl = 'https://chat.whatsapp.com/KMbNv97dG03DI0PPzFmGTM?mode=ac_t'
...
console.log(chalk.cyanBright.bold('elaina&vita\n'));
loadPlug();
startBot();
watchCfg();
